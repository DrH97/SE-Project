...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 02, 2017 at 06:13 AM
...
INSERT INTO `member` (`member_id`, `firstname`, `lastname`, `email`, `password`, `gender`, `address`, `contact`, `type`, `year_level`, `status`) VALUES
...
(66, 'j', 'j', 'j@j.j', '$2y$10$WzoJSaDIxmhyIaprqJ3HkO3.0BgbVX9bPAiNfzNIIOUnQ0qvsf35e', '', '', '', '', '', ''),
(67, 'j', 'j', 'j@j.j', '$2y$10$0evsS9d/0ocQ.s/0H6s8eugGzC4.nv20R0H8T6tgM0WGxyJCEKlaG', '', '', '', '', '', ''),
(68, 'John', 'Smith', 'johnsmith@gmail.com', '$2y$10$NJzA8F61xQF8n64y4VQEzu1HcauEvW1dtPtqGs9dnBdjQCPKsaXCe', '', '', '', '', '', ''),
(69, 'John', 'Smith', 'johnsmith@gmail.com', '$2y$10$JBbis1E18cq9.jt.k4OKpuJqlWzEIzTbD8kzr1iNfbxxifsBY1oq6', '', '', '', '', '', '');
